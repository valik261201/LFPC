...
Vn_brut = input("Defineste elementele nonterminale prin spatiu\n")
vn = Vn_brut.split(" ")
Vt_brut = input("Defineste elementele terminale prin spatiu\n")
vt = Vt_brut.split(" ")
...
for i in range(nr_rel):
    r = input()
    rules.append(r)
wordFA = input("Introdu cuvantul pentru verificare: \n")
diction = {}
firsts = {}
follows = {}
computeAllFirsts()
